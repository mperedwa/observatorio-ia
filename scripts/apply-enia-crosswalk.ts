...
const decisionesEspecificas: Record<string, DecisionCruce> = {
  ...
  'enia-2-1-3-02': decision(
    'mapeado-exacto',
    ['micitt-linc'],
    'El registro nombra expresamente a LINC y el catálogo contiene la misma red de Laboratorios de Innovación Comunitaria. La operación general está verificada; no lo está el cumplimiento íntegro de la meta municipal de este registro.',
    'The record expressly names LINC, and the catalogue contains the same Community Innovation Labs network. General operation is verified; full delivery of this record’s municipal target is not.',
    {
      estadoEjecucion: 'parcialmente-verificado',
      faseRealVerificada: 'operativo',
    },
  ...
  'enia-2-2-2-01': decision(
    'coincidencia-parcial',
    ['micitt-agroboost'],
    'AgroBoost aporta evidencia de asistencia y transferencia tecnológica a unidades productivas agrícolas, una parte del alcance amplio para emprendimientos, PYMES y PYMPAS. No hay identidad documental con toda la intervención.',
    'AgroBoost provides evidence of assistance and technology transfer to agricultural production units, part of the broader scope for ventures, SMEs and small agricultural producers. Documentary identity with the full intervention is not established.',
    {
      estadoEjecucion: 'parcialmente-verificado',
      faseRealVerificada: 'operativo',
    },
  ...
  'enia-4-1-3-05': decision(
    'mapeado-exacto',
    ['inamu-ela'],
    'La ficha inamu-ela corresponde a la aplicación institucional descrita por este registro. Las fuentes oficiales confirman disponibilidad, técnica de IA y uso; la coincidencia no implica que la meta de 1.200 atenciones esté verificada.',
    'The inamu-ela record corresponds to the institutional application described by this Plan record. Official sources confirm availability, AI technique and use; the match does not establish delivery of the 1,200-service target.',
    {
  ...
  'enia-4-1-3-10': decision(
    ...
    'El catálogo documenta una solución analítica de detección de anomalías y un asistente tributario en operación. Ambos cubren partes de la formulación amplia, pero el registro no los nombra ni prueba todas las funcionalidades previstas.',
    'The catalogue documents an anomaly-detection analytics solution and an operating tax assistant. Both cover parts of the broad wording, but the record does not name them or prove every planned function.',
    {
      estadoEjecucion: 'parcialmente-verificado',
      faseRealVerificada: 'operativo',
    },
  ...
  'enia-4-1-3-15': decision(
    ...
    'El registro describe una cartera institucional amplia. Las cinco fichas relacionadas demuestran capacidades o soluciones que cubren partes del alcance, pero ninguna fuente permite atribuirles el porcentaje base de 67 ni tratarlas como una sola iniciativa.',
    'The record describes a broad institutional portfolio. The five related records demonstrate capabilities or solutions covering parts of that scope, but no source supports attributing the 67 baseline percentage to them or treating them as one initiative.',
    {
      estadoEjecucion: 'parcialmente-verificado',
    },
  ),
  'enia-4-1-3-16': decision(
    'coincidencia-parcial',
    ['ccss-lidia'],
    'LIDIA confirma modelos predictivos clínicos sobre EDUS y coincide con una parte sustantiva del objetivo. La intervención es más amplia: incluye patrones epidemiológicos, patologías y comportamientos, y no nombra a LIDIA.',
    'LIDIA confirms clinical predictive models using EDUS and matches a substantial part of the objective. The intervention is broader: it includes epidemiological patterns, pathologies and service behavior, and does not name LIDIA.',
    {
      estadoEjecucion: 'parcialmente-verificado',
  ...
  'enia-4-1-3-18': decision(
    'coincidencia-parcial',
    ['ccss-tec-formacion'],
    'El programa TEC-CCSS verifica formación y prototipos en IA, por lo que materializa parte de la intervención. No demuestra la estrategia institucional completa de tecnologías emergentes, automatización y programación visual.',
    'The TEC-CCSS program verifies AI training and prototypes, so it delivers part of the intervention. It does not establish the full institutional strategy for emerging technologies, automation and visual programming.',
    {
      estadoEjecucion: 'parcialmente-verificado',
      faseRealVerificada: 'finalizado',
    },
  ...
  'enia-4-1-3-24': decision(
    ...
    'La ficha ins-reclamos-medicos-ia corresponde al proceso de reclamación e indemnización descrito por este registro. Un boletín oficial anterior al Plan confirma operación y resultados reportados, aunque la técnica y la gobernanza permanecen sin determinar.',
    'The ins-reclamos-medicos-ia record corresponds to the claim and reimbursement process described by this Plan record. An official bulletin predating the Plan confirms operation and reported results, although technique and governance remain undetermined.',
    {
      estadoEjecucion: 'verificado',
      faseRealVerificada: 'operativo',
      evidenciasExternas: [
  ...
  'enia-5-2-2-01': decision(
    'mapeado-exacto',
    ['micitt-linc'],
    'El registro identifica expresamente a LINC como medio para capacitar población y el catálogo documenta la misma red en operación. La evidencia no permite verificar todas las alianzas o metas futuras.',
    'The record expressly identifies LINC as a vehicle for public training, and the catalogue documents the same operating network. The evidence does not verify every partnership or future target.',
    {
      estadoEjecucion: 'parcialmente-verificado',
      faseRealVerificada: 'operativo',
    },
  ...
  'enia-5-2-3-02': decision(
    'coincidencia-parcial',
    ['mep-intel'],
    'La especialidad MEP-Intel demuestra incorporación curricular de IA en educación técnica secundaria. La intervención abarca primaria y secundaria académica de forma más amplia, por lo que no se considera identidad exacta.',
    'The MEP-Intel specialization demonstrates AI curriculum adoption in technical secondary education. The intervention more broadly covers primary and academic secondary education, so it is not treated as an exact identity.',
    {
      estadoEjecucion: 'parcialmente-verificado',
      faseRealVerificada: 'operativo',
    },
  ...
  'enia-6-1-2-01': decision(
    'coincidencia-parcial',
    ['cenat-lania'],
    'LaNIA comparte la función de capacitación, sensibilización y desarrollo de iniciativas de alto impacto, pero la evidencia disponible no demuestra que sea el Centro Nacional de Excelencia definido por este registro ni que esté operativo.',
    'LaNIA shares the training, awareness and high-impact initiative-development function, but available evidence does not establish that it is the National Center of Excellence defined by this record or that it is operating.',
    {
...
const notasEspecificas: Record<string, Bilingual> = {
  'enia-4-1-3-04': bilingue(
    'El MTSS mantiene un chat de atención desde 2018, pero las fuentes oficiales localizadas no lo describen como IA ni demuestran la creación del chatbot previsto por este registro.',
    'MTSS has operated a support chat since 2018, but the official sources found do not describe it as AI or establish creation of the chatbot anticipated by this record.',
  ),
  ...
  'enia-4-1-3-19': bilingue(
    'No se localizó evidencia externa del componente de auditoría automatizada con IA sobre SIES/MISE. La intervención reaparece con redacción equivalente en enia-4-1-3-23.',
    'No external evidence was found for the AI-based automated-audit component over SIES/MISE. The intervention reappears with equivalent wording in enia-4-1-3-23.',
  ),
  ...
  'enia-4-1-3-25': bilingue(
    'La investigación documental no encontró formalización, convenio, contratación, piloto ni resultado ICE-OIJ. OIJ-TEC y SUPERCOP son iniciativas distintas y no deben fusionarse con este registro. El Plan reutiliza además el mismo indicador y metas en enia-5-1-1-02 para un objetivo educativo diferente.',
    'Documentary research found no formalization, agreement, procurement, pilot or result for ICE-OIJ. OIJ-TEC and SUPERCOP are separate initiatives and must not be merged with this record. The Plan also reuses the same indicator and targets in enia-5-1-1-02 for a different education objective.',
  ),
  ...
  'enia-4-1-3-29': bilingue(
    'RPA automatiza tareas mediante reglas y no constituye por sí sola evidencia de inteligencia artificial. El registro se conserva como automatización digital.',
    'RPA automates tasks through rules and is not, by itself, evidence of artificial intelligence. The record remains classified as digital automation.',
  ),
  'enia-5-1-1-02': bilingue(
    'El registro describe análisis estadístico para ubicar espacios de educación virtual, no un sistema de IA. El indicador y las metas 0/30/65 son idénticos a los de predicción de homicidios en enia-4-1-3-25, una anomalía del documento que no se corrige por inferencia.',
    'The record describes statistical analysis to locate virtual-education spaces, not an AI system. Its indicator and 0/30/65 targets are identical to those for homicide prediction in enia-4-1-3-25, a document anomaly that is not corrected by inference.',
  ),
};
...
function decisionPorDefecto(
  ...
  if (esSolucionDeclarada) {
    return decision(
      'enia-solamente',
      [],
      'El registro declara una solución o componente de IA, pero al corte solo se verificó su inclusión en el Plan: no tiene coincidencia suficiente en el catálogo ni evidencia externa de ejecución.',
      'The record declares an AI solution or component, but at the cutoff only its inclusion in the Plan was verified: it has neither a sufficient catalogue match nor external execution evidence.',
    );
  }
  ...
  return decision(
    'no-es-sistema-ia',
    [],
    `El registro corresponde a ${etiqueta.es}; es relevante para el ecosistema, pero no describe por sí mismo la implementación de un sistema de IA.`,
    `The record concerns ${etiqueta.en}; it is relevant to the ecosystem but does not itself describe implementation of an AI system.`,
  );
}
...
function decisionDuplicado(id: string, duplicado: Duplicado): DecisionCruce {
  return decision(
    ...
    `La redacción, institución, indicador o metas reproducen sustancialmente la intervención ${duplicado.intervencionCanonicaId}. Se conserva este registro oficial y se vincula a esa intervención para contar la acción una sola vez.`,
    `The wording, institution, indicator or targets substantially reproduce intervention ${duplicado.intervencionCanonicaId}. This official record is preserved and linked to that intervention so the action is counted only once.`,
    {
...
if (intervenciones.length !== 129 || intervencionIds.size !== 129) {
  throw new Error(
    `El script está fijado a 129 registros; recibió ${intervenciones.length} registros y ${intervencionIds.size} IDs.`,
  );
}
...
for (const [id, duplicado] of Object.entries(duplicados)) {
  if (!intervencionIds.has(duplicado.intervencionCanonicaId)) {
    throw new Error(
      `${id} referencia una intervención principal inexistente: ${duplicado.intervencionCanonicaId}`,
    );
  }
}
