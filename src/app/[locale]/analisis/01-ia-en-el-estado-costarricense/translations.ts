  ...
  es: {
    ...
    summary: {
      ...
      bullets: [
        ...
        'El Centro Nacional de Excelencia en IA, prometido en la ENIA 2024-2027, <strong>no tiene operación pública documentada</strong>.',
    ...
    retorno: {
      ...
      haciendaPara: 'En 2025, un detector de anomalías sobre el flujo de facturas electrónicas detectó ₡8,000 millones vinculados a facturas simuladas. La facturación electrónica de Costa Rica procesa aproximadamente 3 millones de comprobantes diarios. Esa infraestructura preexistente fue la condición habilitante del detector.',
    ...
    charts: {
      ...
      lidia: {
        title: 'Modelo LIDIA (diabetes tipo 2)',
        ariaLabel: 'LIDIA: alta precisión documentada en piloto',
        svgTitle: 'Modelo LIDIA de la CCSS: alta precisión documentada en piloto de detección de diabetes tipo 2',
        accuracyLabel: 'piloto',
    ...
    vacio: {
      ...
      para1: 'La Estrategia Nacional de Inteligencia Artificial (ENIA) 2024-2027 del MICITT prometió un Centro Nacional de Excelencia en IA. Costa Rica fue el primer país de Centroamérica en tener una política nacional de IA. <strong>El centro no tiene operación pública documentada</strong>.',
      para2: 'Mientras tanto, la UCR investiga ética en IA con financiamiento Erasmus+ y el CeNAT propone LaNIA como plataforma de investigación aplicada. Cada institución construye sus propios sistemas sin obligación formal de coordinar con el MICITT ni compartir aprendizajes.',
    ...
    projects: [
      ...
      { proyecto: 'LIDIA (diabetes tipo 2)', impacto: 'Alta precisión piloto, 1M+ expedientes' },
  ...
  en: {
    ...
    summary: {
      ...
      bullets: [
        ...
        'The National AI Center of Excellence, promised in ENIA 2024-2027, <strong>has no documented public operation</strong>.',
    ...
    retorno: {
      ...
      haciendaPara: 'In 2025, an anomaly detector applied to electronic invoice flows detected ₡8,000 million linked to simulated invoices. Costa Rica\'s e-invoicing system processes approximately 3 million receipts per day. That pre-existing infrastructure was the enabling condition for the detector.',
    ...
    charts: {
      ...
      lidia: {
        title: 'LIDIA model (type 2 diabetes)',
        ariaLabel: 'LIDIA: documented high accuracy in pilot',
        svgTitle: 'CCSS LIDIA model: documented high accuracy in the type 2 diabetes detection pilot',
        accuracyLabel: 'pilot',
    ...
    ccss: {
      ...
      lidiaPara1: 'LIDIA is a machine learning model developed at Clínica Clorito Picado on more than one million EDUS records. It identifies at-risk type 2 diabetes patients with documented high accuracy in the pilot, enabling preventive intervention. The model costs ₡130 million (approx. USD 250,000).',
    ...
    vacio: {
      ...
      para1: 'The MICITT\'s National AI Strategy (ENIA) 2024-2027 promised a National AI Center of Excellence. Costa Rica was the first country in Central America to adopt a national AI policy. <strong>The center has no documented public operation</strong>.',
      para2: 'Meanwhile, UCR conducts AI ethics research with Erasmus+ funding and CeNAT proposes LaNIA as an applied research platform. Each institution builds its own systems without a formal obligation to coordinate with MICITT or share learnings.',
    ...
    projects: [
      ...
      { proyecto: 'LIDIA (type 2 diabetes)', impacto: 'High pilot accuracy, 1M+ records' },
