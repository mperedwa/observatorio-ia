    ...
    <div className="bg-slate-50">
      ...
      <section id="fuentes" className="bg-slate-50">
        <div className="max-w-5xl mx-auto px-6 py-20">
          ...
          {dict.fuentes.enlaces.length > 0 && (
            <div className="mt-6 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm">
              <span className="font-medium text-slate-900">{dict.fuentes.enlacesLabel}:</span>
              {dict.fuentes.enlaces.map((e) => (
                <a
                  key={e.url}
                  href={e.url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-institucional-700 hover:text-institucional-900 underline underline-offset-2"
                >
                  {e.label}
