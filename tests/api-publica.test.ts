...
const RELEASE_ID = '2026-09-15-r13';
const PREVIOUS_RELEASE_ID = '2026-09-08-r12';
...
describe('API pública estática R13', () => {
  ...
  it('congela una release íntegra con checksums y schemas propios', () => {
    ...
    expect(releaseIndex.releases).toHaveLength(6);
  ...
  it('ofrece un bundle completo y CSV tabulares verificables', () => {
    ...
    expect(bundle.datasets.proyectos.count).toBe(32);
  ...
  it('mantiene el endpoint de proyectos sincronizado exactamente con la fuente curada', () => {
    ...
    expect(endpoint.count).toBe(32);
    expect(endpoint.lastUpdate).toBe('2026-09-15T00:00:00.000Z');
